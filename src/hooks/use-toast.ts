...
const TOAST_LIMIT = 1
const TOAST_REMOVE_DELAY = 1000000000 // Muy alto para prevenir auto-remove
const TOAST_AUTO_DISMISS_DELAY = 1000 // 1 segundo para auto-dismiss
...
function toast({ ...props }: Toast) {
  ...
  // Auto-dismiss después de 1 segundo
