                ...
                <SidebarTrigger>
                  <Button 
                    ...
                    className={`
                      ...
                      bg-gradient-to-br from-blue-500 via-purple-600 via-pink-500 to-cyan-500
                      hover:from-purple-600 hover:via-pink-600 hover:via-blue-500 hover:to-cyan-600
                      active:from-pink-600 active:via-cyan-600 active:via-purple-500 active:to-blue-600
                      text-white font-bold
                      shadow-lg shadow-blue-500/30
                      hover:shadow-2xl hover:shadow-purple-500/50
                      active:shadow-xl active:shadow-pink-500/60
                      border-2 border-transparent
                      hover:border-white/30 active:border-white/50
                      transition-all duration-300 ease-in-out
                      transform hover:scale-110 active:scale-95
                      hover:rotate-3 active:rotate-6
                      ...
                      after:shadow-[inset_0_1px_0_rgba(255,255,255,0.3),_inset_0_-1px_0_rgba(0,0,0,0.1)]
                      hover:after:shadow-[inset_0_2px_4px_rgba(255,255,255,0.4),_inset_0_-2px_4px_rgba(0,0,0,0.2)]
                    `}
                  >
                    <Menu className={`
                      ...
                      filter group-hover:drop-shadow-2xl
                    `} />
                    
                    {/* Glow effect */}
                    <div className="absolute -inset-1 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-lg blur-sm opacity-30 group-hover:opacity-60 group-active:opacity-80 transition-opacity duration-300 -z-10"></div>
                    
                    {/* Ripple effect */}
                    <div className="absolute inset-0 bg-white/10 rounded-md opacity-0 group-active:opacity-100 group-active:animate-ping transition-opacity duration-150"></div>
                  </Button>
                </SidebarTrigger>
